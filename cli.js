...
if (typeof process.argv[2] === 'undefined') {
  console.log('Working directory not defined.')
  process.exit(1)
}
const workingDir = process.argv[2]
if (!fs.existsSync(workingDir)){
  console.log(`Working directory ${workingDir} does not exist.`)
  process.exit(1)
}

if (typeof process.argv[3] === 'undefined') {
  console.log('Golden directory not defined.')
  process.exit(1)
}
const goldenDir = process.argv[3]
if (!fs.existsSync(workingDir)){
  console.log(`Golden directory ${goldenDir} does not exist.`)
  process.exit(1)
}
